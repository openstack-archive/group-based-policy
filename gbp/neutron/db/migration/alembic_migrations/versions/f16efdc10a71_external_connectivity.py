...
def upgrade():
    ...
    op.create_table(
        'gp_eap_to_prs_providing_associations',
        ...
        sa.ForeignKeyConstraint(['policy_rule_set_id'],
                                ...
                                ondelete='CASCADE'),
        sa.Column('external_access_policy_id', sa.String(length=36),
                  nullable=True),
        sa.ForeignKeyConstraint(['external_access_policy_id'],
                                ['gp_external_access_policies.id'],
                                ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('policy_rule_set_id',
                                'external_access_policy_id'))

    op.create_table(
        'gp_eap_to_prs_consuming_associations',
        sa.Column('policy_rule_set_id', sa.String(length=36), nullable=True),
        sa.ForeignKeyConstraint(['policy_rule_set_id'],
                                ['gp_policy_rule_sets.id'],
                                ondelete='CASCADE'),
    ...
    op.create_table(
        'gp_eas_to_eap_associations',
        sa.Column('external_access_policy_id', sa.String(length=36),
                  nullable=True),
        sa.ForeignKeyConstraint(['external_access_policy_id'],
                                ['gp_external_access_policies.id'],
                                ondelete='CASCADE'),
        sa.Column('external_access_segment_id', sa.String(length=36),
                  nullable=True),
        sa.ForeignKeyConstraint(['external_access_segment_id'],
                                ['gp_external_access_segments.id'],
                                ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('external_access_policy_id',
                                'external_access_segment_id'))

    op.create_table(
        'gp_external_access_routes',
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint(
            'l3_policy_id', 'external_access_segment_id', 'allocated_address'),
...
def downgrade():
    ...
    op.drop_table('gp_eas_to_l3p_associations')
    op.drop_table('gp_nat_pools')
    op.drop_table('gp_external_access_routes')
    op.drop_table('gp_eas_to_eap_associations')
    op.drop_table('gp_eap_to_prs_consuming_associations')
    op.drop_table('gp_eap_to_prs_providing_associations')
    op.drop_table('gp_external_access_policies')
    op.drop_table('gp_external_access_segments')
