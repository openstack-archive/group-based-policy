...
class GroupPolicyDbPlugin(gpolicy.GroupPolicyPluginBase,
    ...
    def _make_contract_dict(self, ct, fields=None):
        ...
        res['providing_endpoint_groups'] = [
            epg['endpoint_group_id']
            for epg in ct['providing_endpoint_groups']]

        res['consuming_endpoint_groups'] = [
            epg['endpoint_group_id']
            for epg in ct['consuming_endpoint_groups']]
        return self._fields(res, fields)
