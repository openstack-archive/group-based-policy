...
class ExternalAccessSegment(model_base.BASEV2, BaseSharedGbpResource):
    ...
    nat_pools = orm.relationship(NATPool, backref='external_access_segment')
...
class GroupPolicyDbPlugin(gpolicy.GroupPolicyPluginBase,
    ...
    def _make_external_access_segment_dict(self, eas, fields=None):
        ...
        res['nat_pools'] = [np['id'] for np in eas['nat_pools']]
        res['external_access_policies'] = [
            eap['external_access_policy_id']
            for eap in eas['external_access_policies']]
