...
sc_supported_type = [None, constants.VPN, constants.FIREWALL]
...
RESOURCE_ATTRIBUTE_MAP = {
    ...
    SERVICECHAIN_INSTANCES: {
        ...
        'servicechain_spec': {'allow_post': True, 'allow_put': True,
                              ...
                              'default': None, 'is_visible': True,
                              'required': True},
        'provider_epg': {'allow_post': True, 'allow_put': True,
                         'validate': {'type:uuid_or_none': None},
                         'is_visible': True, 'default': None,
                         'required': True},
        'consumer_epg': {'allow_post': True, 'allow_put': True,
                         'validate': {'type:uuid_or_none': None},
                         'is_visible': True, 'default': None,
                         'required': True},
        'classifier': {'allow_post': True, 'allow_put': True,
                       ...
                       'is_visible': True, 'default': None,
                       'required': True},
        'config_param_values': {'allow_post': True, 'allow_put': True,
                          'validate': {'type:string': None},
                          'default': "", 'is_visible': True},
    },
}
...
class ServiceChainPluginBase(service_base.ServicePluginBase):
    ...
    def get_servicechain_spec(self, context, servicechain_spec_id,
                              fields=None):
        #LOG.info(_("get_servicechain_spec"))
        pass
