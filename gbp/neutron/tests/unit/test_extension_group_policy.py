...
class GroupPolicyExtensionTestCase(test_api_v2_extension.ExtensionTestCase):
    ...
    def _test_create_policy_action(self, data, expected_value,
        ...
        instance.create_policy_action.return_value = expected_value
        res = self.api.post(_get_path(POLICY_ACTIONS_URI, fmt=self.fmt),
                            self.serialize(data),
                            content_type='application/%s' % self.fmt)
        instance.create_policy_action.assert_called_once_with(mock.ANY,
                                                              policy_action=
                                                              default_data)
    ...
    def test_create_policy_action_with_defaults(self):
        ...
        expected_value = copy.copy(data['policy_action'])
        expected_value.update({'id': policy_action_id})
        expected_value.update(default_attrs)
    ...
    def test_create_policy_action(self):
        ...
        expected_value = copy.deepcopy(data['policy_action'])
        expected_value.update({'id': policy_action_id})
    ...
    def _test_create_policy_classifier(self, data, expected_value,
        ...
        instance = self.plugin.return_value
        instance.create_policy_classifier.return_value = expected_value
        res = self.api.post(_get_path(POLICY_CLASSIFIERS_URI, fmt=self.fmt),
                            self.serialize(data),
                            content_type='application/%s' % self.fmt)
        instance.create_policy_classifier.assert_called_once_with(
    ...
    def test_create_policy_classifier_with_defaults(self):
        ...
        expected_value = copy.copy(data['policy_classifier'])
        expected_value.update({'id': policy_classifier_id})
        expected_value.update(default_attrs)
    ...
    def test_create_policy_classifier(self):
        ...
        expected_value = copy.deepcopy(data['policy_classifier'])
        expected_value.update({'id': policy_classifier_id})
    ...
    def _test_create_policy_rule(self, data, expected_value,
        ...
        instance = self.plugin.return_value
        instance.create_policy_rule.return_value = expected_value
        res = self.api.post(_get_path(POLICY_RULES_URI, fmt=self.fmt),
                            self.serialize(data),
                            content_type='application/%s' % self.fmt)
        instance.create_policy_rule.assert_called_once_with(
    ...
    def test_create_policy_rule_with_defaults(self):
        ...
        expected_value = copy.copy(data['policy_rule'])
        expected_value.update({'id': policy_rule_id})
        expected_value.update(default_attrs)
    ...
    def test_create_policy_rule(self):
        ...
        expected_value = copy.deepcopy(data['policy_rule'])
        expected_value.update({'id': policy_rule_id})
    ...
    def _test_create_contract(self, data, expected_value, default_data=None):
        ...
        instance = self.plugin.return_value
        instance.create_contract.return_value = expected_value
        res = self.api.post(_get_path(CONTRACTS_URI, fmt=self.fmt),
                            self.serialize(data),
                            content_type='application/%s' % self.fmt)
        instance.create_contract.assert_called_once_with(
    ...
    def test_create_contract_with_defaults(self):
        ...
        expected_value = copy.copy(data['contract'])
        expected_value.update({'id': contract_id})
        expected_value.update(default_attrs)
    ...
    def test_create_contract(self):
        ...
        expected_value = copy.deepcopy(data['contract'])
        expected_value.update({'id': contract_id})
