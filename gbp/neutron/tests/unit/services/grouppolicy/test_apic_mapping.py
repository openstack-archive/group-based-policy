...
class TestEndpoint(ApicMappingTestCase):
    # TODO(ivar): test path created/destroyed on APIC
    # Created when: EP created with bound port, EP port updated
    # Deleted when: EP port updated, Last EP of that port 'kind' deleted
    pass
