...
class GroupPolicyDBTestBase(object):
    ...
    def _get_test_contraprs_attrs(self, name='policy_rule_set1',
...
class TestGroupResources(GroupPolicyDbTestCase):
    ...
    def test_create_and_show_policy_rule_set(self):
        ...
        attrs = self._get_test_contraprs_attrs(name=name)
    ...
    def test_create_contraprs_with_multiple_rules_children(self, **kwargs):
        policy_classifiers = [
            self.create_policy_classifier()['policy_classifier']['id'],
            self.create_policy_classifier()['policy_classifier']['id']]
        policy_rules = sorted([
        ...
        child_policy_rule_sets = sorted(
            [self.create_policy_rule_set()['policy_rule_set']['id'],
             self.create_policy_rule_set()['policy_rule_set']['id']])
        attrs = self._get_test_contraprs_attrs(
            policy_rules=policy_rules,
            child_policy_rule_sets=child_policy_rule_sets)
    ...
    def test_create_child_contraprs_fail(self, **kwargs):
    ...
    def test_contraprs_one_hierarchy_children(self):
    ...
    def test_contraprs_one_hierarchy_parent(self):
        child = self.create_policy_rule_set()['policy_rule_set']
        # parent
        self.create_policy_rule_set(
            child_policy_rule_sets=[child['id']])['policy_rule_set']
    ...
    def test_contraprs_parent_no_loop(self):
