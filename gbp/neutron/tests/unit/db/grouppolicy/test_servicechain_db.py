...
class serviceChainDBTestBase(object):
    ...
    def create_servicechain_node(self, service_type="fw", config="{}",
...
class TestServiceChainResources(serviceChainDbTestCase):
    ...
    def test_create_and_show_servicechain_node(self):
        attrs = self._get_test_servicechain_node_attrs(service_type="lb",
                                                       config="config1")

        scn = self.create_servicechain_node(service_type="lb",
                                           config="config1")
