...
class GroupPolicyMappingDbTestCase(tgpdb.GroupPolicyDbTestCase,
    ...
    def _get_test_policy_target_group_attrs(
        self, name='ptg1', description='test ptg', l2_policy_id=None,
        provided_policy_rule_sets=None, consumed_policy_rule_sets=None,
        subnets=None):
        attrs = (super(GroupPolicyMappingDbTestCase, self).
