...
class ResourceMappingDriver(api.PolicyDriver):
    ...
    def _handle_redirect_action(self, context, contracts):
        for contract_id in contracts:
            epg_mapping = self._get_contract_epg_mapping(context, contract_id)
            epgs_consuming_contract = epg_mapping['consuming_epgs']
            epgs_providing_contract = epg_mapping['providing_epgs']
