...
class OdlManager(object):
    ...
    def __init__(self):
        ...
        self._crt_tenant_url = self._base_url + \
                               '/config/policy:tenants/policy:tenant'
    ...
    def create_tenant(self, tenant):
        """Create tenant in ODL controller"""
        data = {"id": tenant,
                "name": tenant,
                "description": tenant}
        self.sendjson('PUT', self._crt_tenant_url, self._headers, data)
