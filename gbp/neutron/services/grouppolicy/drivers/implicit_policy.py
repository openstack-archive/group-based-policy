...
class ImplicitPolicyDriver(api.PolicyDriver):
    ...
    def _use_implicit_l2_policy(self, context):
        ...
        if context.current['shared'] is True and l2p['shared'] is False:
            raise exc.SharedResourceReferenceError(
                            res_type='policy_target_group',
                            res_id=context.current['id'],
                            ref_type='l2_policy', ref_id=l2p['id'])
    ...
    def _use_implicit_l3_policy(self, context):
        ...
        if context.current['shared'] is True and l3p['shared'] is False:
            raise exc.SharedResourceReferenceError(
                            res_type='l2_policy', res_id=context.current['id'],
                            ref_type='l2_policy', ref_id=l3p['id'])
