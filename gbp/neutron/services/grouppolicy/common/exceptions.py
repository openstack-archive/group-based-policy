...
class NonSharedPolicyTargetGroupOnSharedL2PolicyNotSupported(
        GroupPolicyBadRequest):
    message = _("Non shared Policy Target Group can't reference a shared L2 "
                "Policy of a different tenant")
