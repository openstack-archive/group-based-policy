...
class ExternalAccessSegmentContext(BaseResouceContext,
                                   api.ExternalAccessSegmentContext):
    pass


class ExternalAccessPolicyContext(BaseResouceContext,
                                  api.ExternalAccessPolicyContext):
    pass
