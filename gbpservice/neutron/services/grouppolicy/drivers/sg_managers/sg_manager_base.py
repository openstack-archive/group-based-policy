...
class SecurityGroupManagerBase(local_api.LocalAPI):
    ...
    def _sg_rule(self, plugin_context, tenant_id, sg_id, direction,
        ...
        versions = {4: const.IPv4, 6: const.IPv6, const.IPv4: const.IPv4,
        ...
        attrs = {'tenant_id': tenant_id,
                 ...
                 'direction': direction,
                 'ethertype': versions[ethertype or
    ...
    def _get_enforced_prs_rules(self, context, prs, subset=None):
        ...
        if prs['parent_id']:
            parent = self._get_policy_rule_set(
                context._plugin_context, prs['parent_id'])
            parent_policy_rules = self._get_policy_rules(
                                        context._plugin_context,
                                        filters={'id': parent['policy_rules']})
            subset_rules = self._get_policy_rules(
                                        context._plugin_context,
                                        filters={'id': subset})
    ...
    def _recompute_policy_rule_sets(self, context, children):
        ...
        for child in children:
            child = self._get_policy_rule_set(
            ...
            if child['parent_id']:
                ...
                parent_policy_rules = self._get_policy_rules(
                                        context._plugin_context,
                                        filters={'id': parent['policy_rules']})
                child_rules = self._get_policy_rules(
                                        context._plugin_context,
