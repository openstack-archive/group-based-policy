...
class AIMMappingDriver(nrd.CommonNeutronBase):
    ...
    def update_policy_target_group_precommit(self, context):
        ...
        if ptg_db['l2_policy_id']:
            ...
            if epg:
                provided_contracts += epg.provided_contract_names
                consumed_contracts += epg.consumed_contract_names
    ...
    def _configure_default_epg(self, context, l2p, epg_dn, create=True,
                               delete=False):
        ...
        # EPG
        # create=True, delete=True us not a valid combination
        session = context._plugin_context.session
        aim_ctx = aim_context.AimContext(session)
