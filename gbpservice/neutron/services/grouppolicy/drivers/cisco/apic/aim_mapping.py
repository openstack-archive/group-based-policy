...
class AIMMappingDriver(nrd.CommonNeutronBase):
    ...
    def create_policy_rule_set_precommit(self, context):
        ...
        aim_ctx = self._get_aim_context(context)
        aim_contract = self._aim_contract(context)
        ...
        self._populate_aim_contract_subject(
            context, aim_ctx, aim_contract, rules)
    ...
    def update_policy_rule_set_precommit(self, context):
        ...
        aim_ctx = self._get_aim_context(context)
        self._populate_aim_contract_subject(
            context, aim_ctx, aim_contract, rules, create=False)
    ...
    def _aim_contract(self, context):
    ...
    def _aim_contract_subject(self, context, aim_contract, in_filters=None,
    ...
    def _populate_aim_contract_subject(self, context, aim_ctx, aim_contract,
