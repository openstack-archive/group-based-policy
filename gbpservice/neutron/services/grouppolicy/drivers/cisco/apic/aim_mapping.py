    ...
    def delete_l2_policy_precommit(self, context):
        ...
        if self.create_auto_ptg:
            auto_ptg_id = self.name_mapper.db.get_neutron_id(
                ...
                apic_name=self._get_epg_name_from_dn(default_epg_dn))
            if auto_ptg_id:
...
# TODO(Sumit): Implement get_l2_policy_status()
    ...
    def _create_implicit_contracts_and_configure_default_epg(
        ...
        if self.create_auto_ptg:
            ...
            default_epg_name = self._get_epg_name_from_dn(epg_dn)
    ...
    def _get_epg_name_from_dn(self, epg_dn):
        return epg_dn.split('/')[-1]
