...
class NoValidAddressScope(exc.GroupPolicyBadRequest):
    message = _("No address scope was provided, could be determined, "
                "or could be created for a l3_policy.")
...
class AIMMappingDriver(nrd.CommonNeutronBase, aim_rpc.AIMMappingRPCMixin):
    ...
    def create_l3_policy_precommit(self, context):
        ...
        for family in ip_dict.keys():
            ...
            default_pool = self.ml2plus_plugin.get_default_subnetpool(
            ...
            if explicit_scope:
                ...
                kwargs = {}
                if saved_scope_vrf:
                    kwargs.update({'saved_dn': saved_scope_vrf})
                ...
                saved_scope_vrf = address_scope[
                    cisco_apic.DIST_NAMES][cisco_apic.VRF]
