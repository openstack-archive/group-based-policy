...
# TODO(Sumit): Implement get_l3_policy_status()
    ...
    def delete_l2_policy_precommit(self, context):
        ...
        if self.create_auto_ptg:
            ...
            auto_ptg_id = self.name_mapper.get_auto_ptg_id_from_epg(
                context._plugin_context.session, default_epg_name)
            if auto_ptg_id:
                ...
                if auto_ptg:
                    ...
                    self.name_mapper.delete_apic_name(
...
# TODO(Sumit): Implement get_l2_policy_status()
    ...
    def _create_implicit_contracts_and_configure_default_epg(
        ...
        if self.create_auto_ptg:
            ...
            self.name_mapper.map_auto_ptg_to_epg(
                session, auto_ptg['id'], default_epg_name)
