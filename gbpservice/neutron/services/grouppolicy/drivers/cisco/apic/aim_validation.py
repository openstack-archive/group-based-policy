...
class Manager(object):
    ...
    def register_aim_resource_type(self, klass):
        self.expected_aim_resources.setdefault(klass, {})

    def expect_aim_resource(self, resource):
        expected_resources = self.expected_aim_resources[resource.__class__]
    ...
    def _handle_incorrect_aim_resource(self, expected_resource,
        ...
        if self.should_repair():
            ...
            print("Failed due to incorrect %(type)s: %(actual)r which should "
                  "be: %(data)r" %
