...
class ApicMappingDriver(api.ResourceMappingDriver):
    ...
    def get_gbp_details(self, context, **kwargs):
        ...
        details = {'device': kwargs.get('device'),
                   ...
                   'owned_addresses': list(
                       set(self._get_owned_addresses(context, pt)))}
        if switched:
    ...
    def _add_network_details(self, context, port, details, pt=None):
        ...
        if pt:
            ...
            owned_addresses = set(self._get_owned_addresses(context, pt))
    ...
    def _is_master_owner(self, plugin_context, pt, master_pt=None):
        ...
        # the cluster master.
        owned_addresses = set(self._get_owned_addresses(plugin_context, pt))
    ...
    def _get_owned_addresses(self, plugin_context, pt):
        return self.ha_ip_handler.get_ha_ipaddresses_for_port(pt['port_id'])
