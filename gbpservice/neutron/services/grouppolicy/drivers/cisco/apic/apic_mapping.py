...
class ApicMappingDriver(api.ResourceMappingDriver):
    ...
    def create_policy_target_group_postcommit(self, context):
        ...
        if consumed_prs or provided_prs:
    ...
    def update_external_policy_postcommit(self, context):
        ...
        if added_c_prs:
            self._handle_redirect_action(context, added_c_prs)
    ...
    def _handle_redirect_action(self, context, policy_rule_set_ids):
        super(ApicMappingDriver, self)._handle_redirect_action(
            context, policy_rule_set_ids, one_per_pair=False)