...
class CommonNeutronBase(ipd.ImplicitPolicyBase, rmd.OwnedResourcesOperations,
    ...
    def create_l2_policy_precommit(self, context):
        l2p_db = context._plugin_context.session.query(
            gpmdb.L2PolicyMapping).get(context.current['id'])
        context._plugin_context.session.expunge(l2p_db)
        ...
        context._plugin_context.session.add(l2p_db)
