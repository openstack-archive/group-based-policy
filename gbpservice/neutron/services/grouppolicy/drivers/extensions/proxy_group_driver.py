...
from gbpservice.neutron.services.grouppolicy.extensions import proxy_group


class ProxyGroupDriver(api.ExtensionDriver):
    _supported_extension_alias = 'proxy_group'
    _extension_dict = proxy_group.EXTENDED_ATTRIBUTES_2_0
        ...
        if attributes.is_attr_set(proxied):
            ...
            if record:
                if record.proxy_group_id:
                    raise proxy_group.InvalidProxiedGroup(group_id=proxied)
