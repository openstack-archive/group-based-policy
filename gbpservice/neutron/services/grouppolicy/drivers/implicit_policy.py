        ...
        if not l3p:
            ...
            try:
                ...
                with excutils.save_and_reraise_exception(
                    ...
                    # REVISIT(rkukura): We currently sleep to allow
                    # time for concurrent default L3 policy creation
                    # to complete, then find and use it. We really
                    ...
                    l3p = l3ps and l3ps[0]
                    if not l3p:
                        LOG.warning(_("Overlapping IPPool detected, but "
                                      "default L3 policy not concurrently "
