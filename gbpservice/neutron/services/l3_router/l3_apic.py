...
class ApicL3ServicePluginFIP(db_base_plugin_v2.NeutronDbPluginV2,
    ...
    def __init__(self):
        super(ApicL3ServicePluginFIP, self).__init__()
        self._apic_gbp = None
    ...
    def create_floatingip(self, context, floatingip):
        ...
        res = super(ApicL3ServicePluginFIP, self).create_floatingip(
            context, floatingip)
    ...
    def update_floatingip(self, context, id, floatingip):
        ...
        res = super(ApicL3ServicePluginFIP, self).update_floatingip(
    ...
    def delete_floatingip(self, context, id):
        port_id = self._get_port_mapped_to_floatingip(context, id)
        res = super(ApicL3ServicePluginFIP, self).delete_floatingip(context, id)
        self._notify_port_update(port_id, context)
        return res
