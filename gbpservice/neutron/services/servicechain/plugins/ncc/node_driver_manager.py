...
from gbpservice.neutron.services.servicechain.plugins.ncc import config  # noqa
...
class NodeDriverManager(stevedore.named.NamedExtensionManager):
    ...
    def __init__(self):
        ...
        names = cfg.CONF.node_centric_chain.node_drivers
        LOG.info(_("Configured service chain node driver names: %s"), names)
        super(NodeDriverManager,
              self).__init__(
                  'gbpservice.neutron.servicechain.ncc_drivers', names,
