...
class NodeCompositionPlugin(servicechain_db.ServiceChainDbPlugin,
    ...
    def _is_precommit_policy_driver(self):
        # REVISIT: Currently there is only one pre-commit policy driver,
        # but the check should be done in a way that it allows checking
        # for other similar drivers as and when they are implemented.
