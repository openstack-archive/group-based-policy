...
class OnlyOneFlowClassifierPerRouterIDAllowed(exceptions.BadRequest):
    message = _("Only one flow classifier per router ID is allowed. "
                "Conflicting classifiers: %(current)s %(conflicting)s")
