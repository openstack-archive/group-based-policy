...
def _validate_gbpservice_port_range(data, key_specs=None):
    if data is None:
        return
    data = str(data)
    ports = data.split(':', 1)
...
def _validate_gbpserviceroutes(data, valid_values=None):
...
attr.validators['type:gbpservice_port_range'] = _validate_gbp_port_range
...
attr.validators['type:gbpserviceroutes'] = _validate_gbproutes
...
RESOURCE_ATTRIBUTE_MAP = {
    ...
    POLICY_CLASSIFIERS: {
        ...
        'port_range': {'allow_post': True, 'allow_put': True,
                       'validate': {'type:gbpservice_port_range': None},
    ...
    EXTERNAL_SEGMENTS: {
        ...
        'external_routes': {
            ...
            'validate': {'type:gbpserviceroutes': None},
            'is_visible': True},
