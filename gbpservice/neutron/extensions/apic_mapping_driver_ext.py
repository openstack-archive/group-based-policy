...
CISCO_APIC_GBP_SEGMENTATION_EXT = 'cisco_apic_gbp_segmentation'
...
class Apic_mapping_driver_ext(extensions.ExtensionDescriptor):
    ...
    @classmethod
    def get_alias(cls):
        return CISCO_APIC_GBP_SEGMENTATION_EXT

    @classmethod
    def get_description(cls):
        return _("This extension supportes a list of (micro)segmentation "
