...
def get_lib_db_api_writer_session():
    pre_session()
    new_session = lib_db_api.get_context_manager().writer.get_sessionmaker()()
    post_session(new_session)
    return new_session


lib_db_api.get_writer_session = get_lib_db_api_writer_session
