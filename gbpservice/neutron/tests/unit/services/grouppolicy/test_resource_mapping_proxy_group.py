...
class TestPolicyTarget(ResourceMappingProxyGroupGBPTestCase,
    ...
    def test_group_default_gateway(self):
        ...
        # TODO(ivar): this test depends on bug/1418738
    ...
    def test_group_default_gateway_fails(self):
        # TODO(ivar): this test depends on bug/1418738, gateway port
        # creation will fail because L3 Policy already has the IP.

        # ptg = self.create_policy_target_group()['policy_target_group']
        # pt = self.create_policy_target(
        #     policy_target_group_id=ptg['id'],
        #     group_default_gateway=True,
        #     expected_res_status=500)['policy_target']
        pass
