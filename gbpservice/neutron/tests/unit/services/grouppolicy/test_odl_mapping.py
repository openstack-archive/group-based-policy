...
from gbpservice.neutron.services.grouppolicy.plugin import GroupPolicyPlugin
from gbpservice.neutron.tests.unit.services.grouppolicy import (
    test_grouppolicy_plugin)
...
class PolicyTargetTestCase(OdlMappingTestCase):
    ...
    @patch.object(GroupPolicyPlugin, 'get_l2_policy')
    @patch.object(GroupPolicyPlugin, 'get_policy_target_group')
    @patch.object(Ml2Plugin, 'get_port')
    @patch.object(odl_manager.OdlManager, 'register_endpoints')
    @patch.object(resource_mapping.ResourceMappingDriver,
    ...
    @patch.object(GroupPolicyPlugin, 'get_policy_target_group')
    @patch.object(Ml2Plugin, 'get_port')
    @patch.object(odl_manager.OdlManager, 'unregister_endpoints')
    @patch.object(resource_mapping.ResourceMappingDriver,
...
class L3PolicyTestCase(OdlMappingTestCase):
    ...
    @patch.object(odl_manager.OdlManager, 'create_update_l3_context')
    ...
    @patch.object(odl_manager.OdlManager, 'delete_l3_context')
...
class L2PolicyTestCase(OdlMappingTestCase):
    ...
    @patch.object(Ml2Plugin, 'get_network')
    @patch.object(odl_manager.OdlManager, 'create_update_l2_flood_domain')
    @patch.object(odl_manager.OdlManager, 'create_update_l2_bridge_domain')
    @patch.object(resource_mapping.ResourceMappingDriver,
    ...
    @patch.object(odl_manager.OdlManager, 'delete_l2_flood_domain')
    @patch.object(odl_manager.OdlManager, 'delete_l2_bridge_domain')
    @patch.object(resource_mapping.ResourceMappingDriver,
...
class PolicyTargetGroupTestCase(OdlMappingTestCase):
    ...
    @patch.object(GroupPolicyPlugin, 'get_policy_action')
    @patch.object(GroupPolicyPlugin, 'get_policy_classifier')
    @patch.object(GroupPolicyPlugin, 'get_policy_rule')
    @patch.object(GroupPolicyPlugin, 'get_policy_rule_set')
    @patch.object(Ml2Plugin, 'get_subnet')
    @patch.object(odl_manager.OdlManager, 'create_update_subnet')
    @patch.object(odl_manager.OdlManager, 'create_update_endpoint_group')
    @patch.object(odl_manager.OdlManager, 'create_update_contract')
    @patch.object(resource_mapping.ResourceMappingDriver,
    ...
    @patch.object(odl_mapping.OdlMappingDriver, '_cleanup_subnet')
    @patch.object(odl_manager.OdlManager, 'delete_endpoint_group')
    @patch.object(odl_manager.OdlManager, 'delete_subnet')
...
class PolicyClassifierTestCase(OdlMappingTestCase):
    ...
    @patch.object(odl_manager.OdlManager, 'create_classifier')
    ...
    @patch.object(odl_manager.OdlManager, 'delete_classifier')
...
class DHCPTestCase(OdlMappingTestCase):
    ...
    @patch.object(GroupPolicyPlugin, 'create_policy_target')
    @patch.object(odl_mapping.OdlMappingDriver, '_port_is_owned')
    @patch.object(Ml2Plugin, '_get_subnets_by_network')
