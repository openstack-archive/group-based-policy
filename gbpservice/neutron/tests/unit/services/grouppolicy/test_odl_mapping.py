...
from gbpservice.neutron.tests.unit.services.grouppolicy import test_grouppolicy_plugin
...
class TestL3Policy(OdlMappingTestCase):
    ...
    def setUp(self):
        ...
        self._gbpservice_plugin = FakeGBPPlugin()
        ...
        self._gbpservice_plugin.add_l3_policy(l3p_id, l3p)
        self._l3p_id = l3p_id

    def _get_l3_policy_operation_context(self):
        current = self._gbpservice_plugin.get_l3_policy(
...
class TestL2Policy(OdlMappingTestCase):
    ...
    def setUp(self):
        ...
        self._gbpservice_plugin.add_l2_policy(l2p_id, l2p)
        self._l2p_id = l2p_id

    def _get_l2_policy_operation_context(self):
        current = self._gbpservice_plugin.get_l2_policy(
...
class TestPolicyClassifier(OdlMappingTestCase):
    ...
    def setUp(self):
        ...
        self._gbpservice_plugin.add_policy_classifier(classifier_id, classifier)
        self._classifier_id = classifier_id

    def _get_policy_classifier_context(self):
        current = self._gbpservice_plugin.get_policy_classifier(
...
class TestPolicyTargetGroup(OdlMappingTestCase):
    def setUp(self):
        ...
        self._gbpservice_plugin.add_policy_action(action_id, action)
        ...
        self._gbpservice_plugin.add_policy_classifier(http_classifier_id,
                                               http_classifier)
        ...
        self._gbpservice_plugin.add_policy_rule(http_rule_id, http_rule)
        ...
        self._gbpservice_plugin.add_policy_classifier(icmp_classifier_id,
                                               icmp_classifier)
        ...
        self._gbpservice_plugin.add_policy_rule(icmp_rule_id, icmp_rule)
        ...
        self._gbpservice_plugin.add_policy_rule_set(icmp_rule_set_id,
                                             icmp_rule_set)
        ...
        self._gbpservice_plugin.add_policy_rule_set(http_rule_set_id,
                                             http_rule_set)
        ...
        self._gbpservice_plugin.add_policy_target_group(group_id, group)
        self._group_id = group_id

    def _get_policy_target_group_context(self):
        current = self._gbpservice_plugin.get_policy_target_group(
            "test_ptg_context", self._group_id
        )
        _plugin_context = "fake_plugin_context_for_ptg_test"
        _plugin = self._gbpservice_plugin
        context = mock.Mock(
            current=current,
            _plugin_context=_plugin_context,
            _plugin=_plugin
