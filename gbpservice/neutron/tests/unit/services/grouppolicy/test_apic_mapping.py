...
class ApicMappingTestCase(
    ...
    def setUp(self, sc_plugin=None, nat_enabled=True):
        ...
        self.driver.attestator.apic.vmm_shared_secret = 'dirtylittlesecret'
        self.driver.attestator.apic.db.get_switch_and_port_for_host = (
...
class TestPolicyTarget(ApicMappingTestCase):
    ...
    def test_attestation(self):
        ...
        self.assertEqual(details['attestation'][0]['name'], pt1['port_id'])
