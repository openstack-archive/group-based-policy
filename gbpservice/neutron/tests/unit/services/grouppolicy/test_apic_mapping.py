...
class ApicMappingTestCase(
    ...
    def setUp(self):
        ...
        ml2_opts = {
            ...
            'tenant_network_types': ['flat', 'opflex']
        }
...
class TestL3Policy(ApicMappingTestCase):
    ...
    def _get_external_segment(self, id):
        req = self.new_show_request('external_segments', id, fmt=self.fmt)
        return self.deserialize(
            self.fmt, req.get_response(self.api))['external_segment']
    ...
    def _test_multiple_l3_policy_per_es(self, shared_es=False):
        ...
        self.assertEqual(len(es['l3_policies']), 2)
        ...
        es = self.show_external_segment(es['id'])['external_segment']
        self.assertEqual(len(es['l3_policies']), 3)
