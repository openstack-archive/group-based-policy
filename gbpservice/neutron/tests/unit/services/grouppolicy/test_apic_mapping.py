...
{u'l3extLNodeP': {u'attributes': {u'dn': u'uni/tn-common/out-supported/lnodep-\
Leaf3-4_NP', u'lcOwn': u'local', u'name': u'Leaf3-4_NP', u'targetDscp':
u'unspecified', u'configIssues': u'', u'stateQual': u'', u'tCl': u'',
u'tContextDn': u'', u'tRn': u'', u'type': u'', u'rType': u'', u'state': u'',
u'forceResolve': u'', u'tag': u'yellow-green', u'monPolDn': u'', u'modTs': u'',
 u'uid': u'15374', u'encap': u'unknown', u'addr': u'0.0.0.0'},
                  u'children': [{u'l3extLIfP':
{u'children': [{u'l3extRsPathL3OutAtt': {u'attributes': {u'encap': u'vlan-3101'
                                                         }}}]}}]}},
                           {u'l3extRsEctx': {u'attributes': {u'dn': u'uni/tn-\
common/out-supported/rsectx', u'tDn': u'', u'tnFvCtxName': u'default'}}}])
            }
