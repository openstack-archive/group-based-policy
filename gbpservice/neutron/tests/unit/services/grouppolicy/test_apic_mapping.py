...
class ApicMappingTestCase(
        test_plugin.ResourceMappingTestCase,
...
class TestApicChains(ApicMappingTestCase):
    ...
    # REVISIT(ivar): uncomment when https://review.openstack.org/#/c/164907/
    # is merged
    ...
    def test_service_ports_bound(self):
        ...
        pt_lb_1 = self.create_policy_target(
            ...
            name='chain_provider_1')['policy_target']
        pt_lb_2 = self.create_policy_target(
            policy_target_group_id=provider['id'],
            name='chain_provider_2')['policy_target']
    ...
    def test_new_redirect_action_update(self):
    ...
    def test_ptg_participate_multiple_redirect_prs(self):
    ...
    def test_three_tier_sc(self):
        ...
        internet_web_scs_id = self._create_servicechain_spec(
            node_types=['FIREWALL', 'LOADBALANCER'])
