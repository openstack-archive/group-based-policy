...
class TestPolicyTargetGroup(AIMBaseTestCase):
    ...
    def test_policy_target_group_lifecycle(self):
        ...
        # TODO(Sumit): check addition and deletion of implicit L2P

    # TODO(Sumit): Add test for PTG lifecycle with L2P provided
