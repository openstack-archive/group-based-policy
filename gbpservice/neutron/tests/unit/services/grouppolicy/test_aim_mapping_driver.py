...
class NotificationTest(AIMBaseTestCase):
    ...
    def setUp(self, policy_drivers=None, core_plugin=None, ml2_options=None,
        ...
        self.send_or_queue_notification_call_count = 0
        ...
        self.orig_send_or_queue_notification = (
            local_api._send_or_queue_notification)

        def _send_or_queue_notification(
            transaction_key, notifier_obj, notifier_method, args):
            self.send_or_queue_notification_call_count += 1
            self.orig_send_or_queue_notification(
                transaction_key, notifier_obj, notifier_method, args)
    ...
    def test_dhcp_notifier(self):
        ...
        self.assertEqual(0, self.send_or_queue_notification_call_count)
        ...
        self.assertLess(0, self.send_or_queue_notification_call_count)
