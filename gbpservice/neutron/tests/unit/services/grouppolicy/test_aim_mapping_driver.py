...
class TestGbpDetailsForML2(AIMBaseTestCase,
    ...
    def _do_test_get_gbp_details(self, pre_vrf=None,
        ...
        self.driver.aim_mech_driver.enable_prepared_statements_for_ep_file = (
    ...
    def test_get_gbp_details_with_prepared_statements(self):
        self._do_test_get_gbp_details(enable_prepared_statements=True)
    ...
    def test_get_gbp_details_pre_existing_vrf_with_prepared_statements(self):
        aim_ctx = aim_context.AimContext(self.db_session)
        vrf = self.aim_mgr.create(
            aim_ctx, aim_resource.VRF(tenant_name='common', name='ctx1',
                                      monitored=True))
...
class TestNestedDomainWithPreparedStatement(TestNestedDomain):

    def setUp(self, **kwargs):
        super(TestNestedDomainWithPreparedStatement, self).setUp(**kwargs)
        self.driver.aim_mech_driver.enable_prepared_statements_for_ep_file = (
                                                                        True)
