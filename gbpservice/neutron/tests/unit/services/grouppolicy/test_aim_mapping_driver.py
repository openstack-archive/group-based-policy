...
class NotificationTest(AIMBaseTestCase):
    ...
    def _disable_checks(self, no_batch_event, with_batch_event):
        ...
        n1 = no_batch_event
        n2 = with_batch_event
        if 'network' in n1[0][1]:
            n1[0][1].pop('ipv4_address_scope', None)
            n2[0][1].pop('ipv4_address_scope', None)
            n1[0][1].pop('subnets', None)
            n2[0][1].pop('subnets', None)
        if 'network' in n1[0][2]:
            n1[0][2].pop('ipv4_address_scope', None)
            n2[0][2].pop('ipv4_address_scope', None)
            n1[0][2].pop('subnets', None)
            n2[0][2].pop('subnets', None)
