...
class TestGbpDetails(AIMBaseTestCase,
    ...
    def _do_test_get_gbp_details(self, pre_vrf=None):
        ...
        self._router_interface_action('add', rtr1['id'], subnet['id'], None)
        ...
        subnet = self._get_object('subnets', net_db['subnets'][0], self.api)

        self._verify_gbp_details_assertions(
            mapping, req_mapping, p1['id'], epg_name, epg_tenant, subnet)
        ...
        p2 = self._make_port(self.fmt, net1['id'],
                             device_owner='compute:')['port']
