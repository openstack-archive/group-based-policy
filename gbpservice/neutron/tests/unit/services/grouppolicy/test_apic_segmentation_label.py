...
from gbpservice.neutron.extensions import apic_segmentation_label as attributes
...
class TestAttributes(base.BaseTestCase):
    ...
    def test_validate_list_of_unique_strings(self):
        data = "TEST"
        msg = attributes._validate_list_of_unique_strings(data, None)
        ...
        msg = attributes._validate_list_of_unique_strings(data, 8)
