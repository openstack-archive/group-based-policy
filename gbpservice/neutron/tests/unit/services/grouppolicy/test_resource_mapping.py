...
class ResourceMappingTestCase(test_plugin.GroupPolicyPluginTestCase):
    ...
    def setUp(self, policy_drivers=None,
        ...
        self._qos_plugin = plugins.get(pconst.QOS)
        a=2+2
...
class TestNetworkServicePolicy(ResourceMappingTestCase):
    ...
    def test_nsp_creation_for_qos_maxrate(self):
        ...
        self._verify_qos_rule(qos_rules)
    ...
    def test_create_ptg_with_ports_existing_nsp(self):
        ...
        self.assertEquals(mapping['qos_policy_id'], port1['qos_policy_id'])
        self.assertEquals(mapping['qos_policy_id'], port2['qos_policy_id'])
