...
class ResourceMappingTestCase(test_plugin.GroupPolicyPluginTestCase):
    ...
    def setUp(self, policy_drivers=None,
              ...
              ml2_options=None, service_plugins=None,
              sc_plugin=None):
        ...
        if service_plugins is None:
            service_plugins = {'qos_plugin_name': "qos"}
        if not ml2_options:
            ml2_options = {
                'mechanism_drivers': ['openvswitch'],
                'extension_drivers': ['qos', 'port_security']
            }
        if 'qos' not in ml2_options['extension_drivers']:
            ml2_options['extension_drivers'].append('qos')
        ml2_opts = ml2_options
