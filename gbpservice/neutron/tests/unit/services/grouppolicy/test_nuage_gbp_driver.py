...
FAKE_GBP_APP = 'ut_gbpservice_app'
...
class FakeNuageGBPClient(fake_nuageclient.FakeNuageClient):
    ...
    def update_ptg_postcommit(self, context, gbpservice_policyruleset,
                              application):
        pass
    ...
    def create_policyrule_postcommit(self, context,
                                     gbpservice_action, gbp_classifier,
                                     application):
        pass
