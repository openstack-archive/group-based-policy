...
class NsxPolicyMappingTestCase(test_rmd.ResourceMappingTestCase):
    ...
    def _mock_nth_map_update_fails(self, n=2):
        self.call_count = 1
...
class TestPolicyTargetGroup(NsxPolicyMappingTestCase):
    ...
    def test_create_fail_multi_connected(self):
        ...
        with self._mock_group_create(),\
            self._mock_profile_list(profile_ids),\
            self._mock_nth_map_update_fails(n=6) as map_update,\
            ...
            b = mock.ANY
            map_update_calls = [self.ingress_map_call(prs1, [a], [b]),
            ...
            map_update.assert_has_calls(map_update_calls, any_order=True)
...
class TestPolicyTargetTag(NsxPolicyMappingTestCase):
    ...
    def test_target_lifecycle(self):
        ...
        # update policy target with cosmetics should not affect backend
        self.update_policy_target(target['id'], description='What a target')
