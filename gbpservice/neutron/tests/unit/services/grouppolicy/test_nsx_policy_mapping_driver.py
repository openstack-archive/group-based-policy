...
class TestPolicyClassifier(NsxPolicyMappingTestCase):
    ...
    def test_policy_classifier_delete(self):
        with self._mock_existing_domain(),\
            ...
            # TODO(annak): delete domain if last service deleted
            self.delete_policy_classifier(classifier['id'])

            service_delete_call.assert_called_once()
...
class TestPolicyTargetGroup(NsxPolicyMappingTestCase):
    ...
    def _test_create_ptg_pair_with_single_rule(self,
                                               direction_in=True,
                                               direction_out=True):
    ...
    def test_create_ptg_pair_with_single_rule_in(self):
        self._test_create_ptg_pair_with_single_rule(True, False)

    def test_create_ptg_pair_with_single_rule_out(self):
        self._test_create_ptg_pair_with_single_rule(False, True)

    def test_create_ptg_pair_with_single_rule_bi(self):
        self._test_create_ptg_pair_with_single_rule(True, True)
    ...
    def test_create_ptg_star(self):
        '''Create star-like topology with single producer and N consumers'''
