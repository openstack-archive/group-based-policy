...
from gbpservice.neutron.services.grouppolicy.drivers.vmware.nsx_policy import nsx_policy_mapping as driver
...
class TestPolicyRuleSet(NsxPolicyMappingTestCase):
    ...
    def test_policy_rule_set_create(self):
        ct = self.create_policy_rule_set(name="ctr")['policy_rule_set']
