...
class TestPolicyTargetGroup(NsxPolicyMappingTestCase):
    ...
    def test_policy_target_group_create_with_single_rule(self):

        # Prepare rule and ruleset
        with mock.patch.object(self.policy_api, 'get',
                               return_value=GET_RESPONSE_DOMAIN_EXISTS),\
        ...
        with mock.patch.object(self.policy_api, 'get',
                              return_value=GET_RESPONSE_DOMAIN_EXISTS),\
            mock.patch.object(self.policy_api, 'create') as group_create,\
            mock.patch.object(self.policy_api,
                             'create_with_parent') as map_create:
