...
class Test_Process_Model(unittest.TestCase):
    ...
    def __test_event_create(self, mock_put):
    ...
    def __test_events_with_same_binding_keys(self, mock_put):
    ...
    def __test_loadbalancing_events(self, mock_put):
        event1 = self.sc.new_event(
    ...
    def __test_serialize_events_serialize_false(self, mock_sequencer):
    ...
    @mock.patch('gbpservice.nfp.core.controller.EventSequencer.add')
    def __test_serialize_events_serialze_true(self, mock_sequencer):
        event1 = self.mock_event(
            id='SERVICE_CREATE', data=self.service1,
            binding_key=self.service1['id'],
            key=self.service1['id'], serialize=True,
    ...
    def __test_EventSequencer_add(self, mocked_sequencer):
        event1 = self.mock_event(
            id='SERVICE_CREATE', data=self.service1,
            binding_key=self.service1['id'],
            key=self.service1['id'], serialize=True,
