...
class AssertionData(object):
    ...
    """ How to Convert simple dict to Ordered dict ?
    simple_dict = {"key1": value1,
                   "key2": value2}

    ordere_dict = OrdereDict([ (key1, value1),
                               (key2, value2)
                            ])
    """
    ...
    create_member_data = OrderedDict([
                             ("timeout", {}),
                             ("server", {
                                "srvr:4910851f-4af7-4592-ad04-08b508c6fa21":
                                ["42.0.0.11:80", "weight 1",
    ...
    delete_member_data = OrderedDict([
                             ("timeout", {}),
                             ("server", {"resource": []})
                         ])
