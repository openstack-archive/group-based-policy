...
class Attributes(object):
    ...
    def get_create_policy_target_default_attrs(self):
        return {'name': '', 'description': '', 'cluster_id': ''}
    ...
    @gbp_attributes
    def get_create_policy_target_required_attrs(self):
        return {'policy_target_group_id': _uuid()}
    ...
    def _is_valid_resource(self, plural):
        return self._is_gbp_resource(plural) or self._is_sc_resource(plural)
