...
from neutron.tests.unit.openvswitch import test_ovs_neutron_agent as ovs_test
from oslo.config import cfg

_uuid = uuidutils.generate_uuid
NOTIFIER = 'neutron.plugins.ml2.rpc.AgentNotifierApi'
GBP_RESERVED_VLAN = 1000
...
class TestGbpOvsAgent(base.BaseTestCase):
    ...
    def setUp(self):
        ...
        cfg.CONF.set_default('firewall_driver',
                             ...
                             group='SECURITYGROUP')
        cfg.CONF.set_override('gbp_reserved_vlan', GBP_RESERVED_VLAN, 'OPFLEX')
    ...
    def test_gbp_reserved_vlan(self):
        cfg.CONF.set_override('gbp_reserved_vlan', 500, 'OPFLEX')
        agent = self._initialize_agent()
        self.assertTrue(len(agent.available_local_vlans) == 4092)
        self.assertTrue(500 not in agent.available_local_vlans)
    ...
    def test_port_bound(self):
        ...
        # Provision local vlan not called
        self.agent.int_br.set_db_attribute.assert_called_with(
            "Port", mock.ANY, "tag", str(GBP_RESERVED_VLAN))
