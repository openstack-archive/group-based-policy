...
class NuageMechanismGBPDriver(api.MechanismDriver):
    ...
    def initialize(self):
        self._nuage_gbpservice = None

    @property
    def nuage_gbpservice(self):
        if not self._nuage_gbpservice:
            self._nuage_gbpservice = (driver.NuageGBPDriver.
                              get_initialized_instance())
        return self._nuage_gbpservice
    ...
    def update_port_postcommit(self, context):
        ...
        if ((not context.original_bound_segment and
            ...
            self.nuage_gbpservice.create_nuage_policy_target(
