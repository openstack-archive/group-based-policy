...
class OdlMechanismGBPDriver(api.MechanismDriver):
    ...
    def initialize(self):
        self._odl_gbpservice = None
        self.vif_type = portbindings.VIF_TYPE_OVS
        self.vif_details = {portbindings.CAP_PORT_FILTER: True}

    @property
    def odl_gbpservice(self):
        if not self._odl_gbpservice:
            self._odl_gbpservice = (odl_mapping.OdlMappingDriver.
                             get_initialized_instance())
        return self._odl_gbpservice
    ...
    def create_port_postcommit(self, context):
        ...
        if (context.current.get('device_owner') ==
            ...
            self.odl_gbpservice.create_dhcp_policy_target_if_needed(
