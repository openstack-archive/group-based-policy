        ...
        if not snat_port or snat_port.fixed_ips is None:
            ...
            for snat_subnet in snat_subnets:
                try:
                    ...
                    # Add a binding record so that update calls will be allowed
                    # through ML2, otherwise ML2 will raise PortNotFound.
                    # REVISIT: Should we disallow updates, specifically binding
                    # related ones?
                    ml2_db.add_port_binding(session, port['id'])
