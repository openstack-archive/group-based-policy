...
class ApicMechanismDriver(api_plus.MechanismDriver,
    ...
    def update_network_precommit(self, context):
        ...
        # Nothing needs to be done for SVI network with pre-existing l3out.
        if not mapping:
            return
    ...
    # TODO(kentwu): Limit 1 subnet per SVI network as each SVI interface
    ...
    def _dissassociate_network_from_vrf(self, ctx, aim_ctx, network_db,
                                        old_vrf, nets_to_notify, is_svi=False):
