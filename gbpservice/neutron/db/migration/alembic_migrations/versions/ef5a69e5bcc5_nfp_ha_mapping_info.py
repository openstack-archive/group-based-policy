...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('vrrp_group', sa.Integer(), nullable=True),
        sa.Column('vip_ip', sa.String(length=36), nullable=True),
    ...
    op.add_column(
        ...
        sa.Column('vendor_data', sa.String(length=1024), nullable=True)
    )
