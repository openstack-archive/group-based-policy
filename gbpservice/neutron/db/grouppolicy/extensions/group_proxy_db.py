...
class ProxyGroupDbManager(object):
    ...
    def _update_proxy_subnetpools_for_l3_policy(self, context, l3p_id,
        ...
        with context.session.begin(subtransactions=True):
            l3p_db = self._get_l3_policy_pool_mapping(context, l3p_id)
    ...
    def _get_l3_policy_pool_mapping(self, context, l3p_id):
        return context.session.query(ProxyIPPoolMapping).filter_by(
