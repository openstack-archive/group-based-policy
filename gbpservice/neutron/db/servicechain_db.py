...
class ServiceChainNode(gquota.GBPQuotaBase, model_base.BASEV2,
                       BaseSharedSCResource):
    """ServiceChain Node"""
...
class ServiceChainSpec(gquota.GBPQuotaBase, model_base.BASEV2,
                       BaseSharedSCResource):
    """ ServiceChain Spec
    """
...
class ServiceProfile(gquota.GBPQuotaBase, model_base.BASEV2,
                     BaseSharedSCResource):
    """ Service Profile
    """
