...
class NovaClient(OpenstackApi):
    ...
    def delete_server_group(self, token, tenant_id, nf_id):
        ...
        try:
            server_group = nova.server_groups.find(name=nf_id)
            server_group_id = server_group.to_dict()['id']
    ...
    def create_server_group(self, token, tenant_id, nf_id):
        ...
        try:
            server_group = nova.server_groups.create(**kwargs)
            server_group_id = server_group.to_dict()['id']
