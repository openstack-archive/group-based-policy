...
from gbpservice.nfp.orchestrator.config_drivers import (
    heat_client as nfp_heat_client)
from gbpservice.nfp.orchestrator.db import nfp_db as nfp_db
from gbpservice.nfp.orchestrator.openstack import (
    openstack_driver as nfp_openstack_driver)

KeystoneClient = nfp_openstack_driver.KeystoneClient
NeutronClient = nfp_openstack_driver.NeutronClient
GBPClient = nfp_openstack_driver.GBPClient
HeatClient = nfp_heat_client.HeatClient
_LE = i18n._LE
_LI = i18n._LI
_LW = i18n._LW
