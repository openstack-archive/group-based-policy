...
# Servicechain instance creation
gbp servicechain-instance-create --servicechain_spec_id firewall-spec --provider_ptg web1 --consumer_ptg web1 --classifier icmp-traffic --config_param_values "vip=IP1" service_chain
...
DEMO_PROJECT_ID=$(keystone tenant-list | grep admin | awk '{print $2}')
