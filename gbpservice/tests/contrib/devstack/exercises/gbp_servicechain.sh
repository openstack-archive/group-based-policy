...
gbp service-profile-create --service-flavor service_vendor=vyos,device_type=None --vendor heat_based_node_driver --insertion-mode l3 --servicetype FIREWALL fw-profile
gbp service-profile-create --service-flavor service_vendor=haproxy,device_type=None --vendor heat_based_node_driver --insertion-mode l3 --servicetype LOADBALANCER lb-profile
