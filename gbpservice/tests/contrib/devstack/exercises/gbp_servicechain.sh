...
gbp service-profile-create --vendor default --insertion-mode l3 --servicetype FIREWALL fw-profile
gbp service-profile-create --vendor default --insertion-mode l3 --servicetype LOADBALANCER lb-profile
