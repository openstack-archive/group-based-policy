...
from gbpservice.nfp.core.main import EventHandlers
from gbpservice.nfp.core.main import RpcAgent
from gbpservice.nfp.core.main import EventSequencer
...
class Test_Process_Model(unittest.TestCase):
    ...
    @patch('gbpservice.nfp.core.main.multiprocessing.queues.Queue.put')
    ...
    @patch('gbpservice.nfp.core.main.EventSequencer.add')
    ...
    @patch('gbpservice.nfp.core.main.EventSequencer')
