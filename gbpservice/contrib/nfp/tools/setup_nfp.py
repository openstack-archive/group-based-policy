...
def add_nova_key_pair():
    ...
    subprocess.call(["cd", "keys"])

    configurator_pvt_key = "configurator_key.pem"
    print("Creating nova keypair for configurator VM.")
    subprocess.call(["nova", "keypair-add", "configurator_key",
                     ">", configurator_pvt_key])
    return configurator_pvt_key
