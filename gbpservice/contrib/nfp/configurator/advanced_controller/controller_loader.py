...
from gbpservice.contrib.nfp.configurator import advanced_controller
...
class ControllerResolver(object):
    ...
    create_network_function_device_config = (
                      advanced_controller.controller.Controller(
                          "create_network_function_device_config")
                                             )
    ...
    get_notifications = advanced_controller.controller.Controller(
                                                        "get_notifications")
    network_function_event = advanced_controller.controller.Controller(
                                                    "network_function_event")
    get_requests = advanced_controller.controller.Controller("get_requests")
