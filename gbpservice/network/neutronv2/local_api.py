...
class LocalAPI(object):
    ...
    def _create_resource(self, plugin, context, resource, attrs,
                         do_notify=True):
        #TODO: fix this: currently: attrs=qos_policy_id; do_notify=attrs
    ...
    def _get_qos_rule(self, plugin_context, qos_rule_id, qos_policy_id):
        return self._get_resource(self._qos_plugin, plugin_context,
                                  'policy_bandwidth_limit_rule', qos_rule_id, qos_policy_id)
    ...
    def _create_qos_rule(self, plugin_context, qos_policy_id, attrs):
        # TODO fate of alternative method?
        return self._create_resource_alternative(self._qos_plugin, plugin_context,
                                     'policy_bandwidth_limit_rule',
                                     qos_policy_id, attrs)
        # return self._create_resource(self._qos_plugin, plugin_context,
        #                              'policy_bandwidth_limit_rule', qos_policy_id, attrs)

    def _update_qos_rule(self, plugin_context, qos_rule_id, qos_policy_id, attrs):
        return self._update_resource(self._qos_plugin, plugin_context,
                                     'policy_bandwidth_limit_rule', qos_rule_id, qos_policy_id, attrs)
